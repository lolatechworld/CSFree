# Write a Python function called calculate_total_cost that calculates the total cost 
# of an order based on the quantity of items ordered and their individual prices. 
# The function should take two parameters:

# quantity: The quantity of items ordered (integer).
# price_per_item: The price per item (float).
# The function should calculate the total cost according to the following:
...
def calculate_total_cost(quantity, price_per_item):
    ...
    if quantity <= 10:
        ...
        actual_price = (quantity * price_per_item * 0.10)
    else:
        print("Error!")
        time.sleep(3)
